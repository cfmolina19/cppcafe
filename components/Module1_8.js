...
const pt = {
  ...
  Module1_8: "Que Legal! O nosso primeiro programa funciona!"
};
const es = {
  Wel:
...
export default class Module1_8 extends React.Component {
  _vocab() {
  ...
  render() {
    return (
      <View style={styles.container}>
        <Text style={styles.paragraph}>{i18n.t("Module1_8")}</Text>

        <Image style={styles.logo} source={require("../assets/Hiworld.png")} />
